...
void Menu::Render()
{
    ...
    ImGui::BeginChild("TabBar", ImVec2(tabBarWidth * dpiScale, contentSize.y), true);
    {
        ...
        ImGui::SetCursorPosX((tabBarWidth * dpiScale - ImGui::CalcTextSize("Il2CppBase").x) * 0.5f); // Your cheat name
        ImGui::TextColored(accentPurple, "Il2CppBase"); // Your cheat name

        ImGui::SetCursorPosX((tabBarWidth * dpiScale - ImGui::CalcTextSize("by VCom Team").x) * 0.5f); // Your author
        ImGui::TextColored(ImVec4(0.7f, 0.7f, 0.8f, 0.8f), "by VCom Team"); // Your author
        ImGui::PopFont();
    ...
    ImGui::BeginChild("ContentArea", ImVec2(contentSize.x - tabBarWidth * dpiScale, contentSize.y), true);
    {
        ...
        case 2:
        {
            ...
            ImGui::BeginChild("Credits", ImVec2(0, 0), true);
            {
                ...
                ImGui::TextWrapped("Evelien (feature system), .gashopeless");
            }
            ImGui::EndChild();
