...
const char* Il2CppBase::GetFeatureTypeIcon(const FeatureType type)
{
    switch (type)
    {
...
const char* Il2CppBase::GetFeatureTypeName(const FeatureType type)
{
    switch (type)
    {
...
{
    constexpr std::array<FeatureType, 1> TYPES = { TYPE_VISUALS };
