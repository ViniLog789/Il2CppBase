...
#define NOTIFY_INFO(message, lifeTime) \
        Il2CppBase::Notifications::AddNotification(message, Il2CppBase::Notifications::NotificationType::Info, lifeTime)
#define NOTIFY_WARNING(message, lifeTime) \
        Il2CppBase::Notifications::AddNotification(message, Il2CppBase::Notifications::NotificationType::Warning, lifeTime)
#define NOTIFY_ERROR(message, lifeTime) \
        Il2CppBase::Notifications::AddNotification(message, Il2CppBase::Notifications::NotificationType::Error, lifeTime)
#define NOTIFY_SUCCESS(message, lifeTime) \
        Il2CppBase::Notifications::AddNotification(message, Il2CppBase::Notifications::NotificationType::Success, lifeTime)
